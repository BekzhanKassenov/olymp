...
int main() {
    ...
    if (sqr_dist >= sqr(r1 + r2)) {
        ...
        double ar = sqrt(sqared_area(r1, r2, dist));
        double h = ar * 2.0 / dist;
        double l1 = sqrt(sqr(r1) - h);
        double l2 = sqrt(sqr(r2) - h);
        
        printf("%.10lf", f(l1, r1) + f(l2, r2));
